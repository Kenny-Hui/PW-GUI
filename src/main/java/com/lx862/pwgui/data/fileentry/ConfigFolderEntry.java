...
import com.lx862.pwgui.gui.panel.editing.filetype.ConfigFolderPanel;
...
public class ConfigFolderEntry extends FileSystemEntityEntry {
    ...
    public List<NameTabPair> getInspectPanels(FileEntryPaneContext context) {
        return addToList(super.getInspectPanels(context), new NameTabPair("Config folder", new ConfigFolderPanel(context)));
    }
}
